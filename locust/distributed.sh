...
export PAYLOAD='{"inputs": "beautiful how ru people",}'
export USERS=3000
export WORKERS=50
export RUN_TIME=2m
...
if $LOCUST_UI ; then
    locust -f $SCRIPT -H $ENDPOINT_NAME --master --expect-workers $WORKERS -u $USERS -t $RUN_TIME --csv results --only-summary &
else
